...
**Breaks if:** you carry equity-sized risk into leveraged FX. The same rule at 50:1 is a different animal, so B2 halves the risk budget in high-VIX regimes; ignore that and one whipsaw is a margin call.
